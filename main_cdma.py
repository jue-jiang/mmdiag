...
from mobilitymisconfigcdma_analyzer import MobilityMisconfigCdmaAnalyzer
import collections
import numpy as np
import os
import pickle
...
def parse_qmdl(plainTextFile):
    ...
    src = OfflineReplayer()
    m = MobilityMisconfigCdmaAnalyzer()
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print "Usage python main_cdma.py [plain text file containing path to mi2log files]"
        exit()
