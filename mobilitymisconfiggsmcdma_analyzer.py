...
class MobilityMisconfigGsmCdmaAnalyzer(Analyzer):
    ...
    def __callback_gsm_rr_cell_information(self, event):
        ...
        if ("GSM", self.__gsm_last_mcc, self.__gsm_last_mnc, self.__gsm_last_lac, self.__gsm_last_cid, self.__gsm_last_bsicncc, self.__gsm_last_bsicbcc) not in self.__gsm_mobility_misconfig_serving_cell_dict.keys():
            self.__gsm_mobility_misconfig_serving_cell_dict[("GSM", self.__gsm_last_mcc, self.__gsm_last_mnc, self.__gsm_last_lac, self.__gsm_last_cid, self.__gsm_last_bsicncc, self.__gsm_last_bsicbcc)] = {}
        if "gsm_geolocation" not in self.__gsm_mobility_misconfig_serving_cell_dict[("GSM", self.__gsm_last_mcc, self.__gsm_last_mnc, self.__gsm_last_lac, self.__gsm_last_cid, self.__gsm_last_bsicncc, self.__gsm_last_bsicbcc)]:
        ...
        if "gsm_cell_information" not in self.__gsm_mobility_misconfig_serving_cell_dict[("GSM", self.__gsm_last_mcc, self.__gsm_last_mnc, self.__gsm_last_lac, self.__gsm_last_cid, self.__gsm_last_bsicncc, self.__gsm_last_bsicbcc)]:
            self.__gsm_mobility_misconfig_serving_cell_dict[("GSM", self.__gsm_last_mcc, self.__gsm_last_mnc, self.__gsm_last_lac, self.__gsm_last_cid, self.__gsm_last_bsicncc, self.__gsm_last_bsicbcc)]["gsm_cell_information"] = []
        self.__gsm_mobility_misconfig_serving_cell_dict[("GSM", self.__gsm_last_mcc, self.__gsm_last_mnc, self.__gsm_last_lac, self.__gsm_last_cid, self.__gsm_last_bsicncc, self.__gsm_last_bsicbcc)]["gsm_cell_information"].append(log_item)
    ...
    def __callback_gsm_rr_cell_reselection_parameters(self, event):
        ...
        # output = subprocess.check_output(command)
        # print output
        if "gsm_reselection_parameters" not in self.__gsm_mobility_misconfig_serving_cell_dict[("GSM", self.__gsm_last_mcc, self.__gsm_last_mnc, self.__gsm_last_lac, self.__gsm_last_cid, self.__gsm_last_bsicncc, self.__gsm_last_bsicbcc)]:
            self.__gsm_mobility_misconfig_serving_cell_dict[("GSM", self.__gsm_last_mcc, self.__gsm_last_mnc, self.__gsm_last_lac, self.__gsm_last_cid, self.__gsm_last_bsicncc, self.__gsm_last_bsicbcc)]["gsm_reselection_parameters"] = []
        self.__gsm_mobility_misconfig_serving_cell_dict[("GSM", self.__gsm_last_mcc, self.__gsm_last_mnc, self.__gsm_last_lac, self.__gsm_last_cid, self.__gsm_last_bsicncc, self.__gsm_last_bsicbcc)]["gsm_reselection_parameters"].append(log_item)
    ...
    def __callback_cdma_paging_channel_message(self, event):
        ...
        if ("RTT", self.__cdma_last_SID, self.__cdma_last_NID, self.__cdma_last_BaseID) not in self.__cdma_mobility_misconfig_serving_cell_dict.keys():
            self.__cdma_mobility_misconfig_serving_cell_dict[("RTT", self.__cdma_last_SID, self.__cdma_last_NID, self.__cdma_last_BaseID)] = {}
        if "cdma_geolocation" not in self.__cdma_mobility_misconfig_serving_cell_dict[("RTT", self.__cdma_last_SID, self.__cdma_last_NID, self.__cdma_last_BaseID)]:
        ...
        # output = subprocess.check_output(command)
        # print output
        if "cdma_paging" not in self.__cdma_mobility_misconfig_serving_cell_dict[("RTT", self.__cdma_last_SID, self.__cdma_last_NID, self.__cdma_last_BaseID)]:
            self.__cdma_mobility_misconfig_serving_cell_dict[("RTT", self.__cdma_last_SID, self.__cdma_last_NID, self.__cdma_last_BaseID)]["cdma_paging"] = []
        self.__cdma_mobility_misconfig_serving_cell_dict[("RTT", self.__cdma_last_SID, self.__cdma_last_NID, self.__cdma_last_BaseID)]["cdma_paging"].append(log_item)
    ...
    def __callback_evdo_signaling_control_channel_broadcast(self, event):
        ...
        if log_item['Message ID'] == 1 and log_item['Protocol Type'] == 15:
            ...
            if "evdo_geolocation" not in self.__evdo_mobility_misconfig_serving_cell_dict[("EVDO", self.__evdo_last_CountryCode, self.__evdo_last_SubnetID, self.__evdo_last_SectorID)]:
            ...
            if "evdo_sector_parameters" not in self.__evdo_mobility_misconfig_serving_cell_dict[("EVDO", self.__evdo_last_CountryCode, self.__evdo_last_SubnetID, self.__evdo_last_SectorID)]:
                self.__evdo_mobility_misconfig_serving_cell_dict[("EVDO", self.__evdo_last_CountryCode, self.__evdo_last_SubnetID, self.__evdo_last_SectorID)]["evdo_sector_parameters"] = []
            self.__evdo_mobility_misconfig_serving_cell_dict[("EVDO", self.__evdo_last_CountryCode, self.__evdo_last_SubnetID, self.__evdo_last_SectorID)]["evdo_sector_parameters"].append(log_item)
            ...
            if int(log_item['Num Other RAT']) > 0:
                ...
                for rat in otherRATs:
                    ...
                    for freq in rat['EUTRAFreqs']:
                        ...
                        if "evdo_other_rat" not in self.__evdo_mobility_misconfig_serving_cell_dict[("EVDO", self.__evdo_last_CountryCode, self.__evdo_last_SubnetID, self.__evdo_last_SectorID)]:
                            self.__evdo_mobility_misconfig_serving_cell_dict[("EVDO", self.__evdo_last_CountryCode, self.__evdo_last_SubnetID, self.__evdo_last_SectorID)]["evdo_other_rat"] = []
                        self.__evdo_mobility_misconfig_serving_cell_dict[("EVDO", self.__evdo_last_CountryCode, self.__evdo_last_SubnetID, self.__evdo_last_SectorID)]["evdo_other_rat"].append(info)
